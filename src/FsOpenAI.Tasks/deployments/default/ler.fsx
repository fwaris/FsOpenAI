...
let defaultSysMessage = """You are a helpful AI assistant that can answer questions over legal demands in an attached document"
"""
...
let localBackend = {Name="local"; BackendType=ChatCompletions}
...
let acctAppCfg =
    {
        ...
        AppBarType = Some (AppB_Base "LER Test UI") //Header bar style and title text
    ...
    [
        {
            ...
            SampleQuestion = "What are legal demands expressed in the attached document. Make sure to include subcriber name and phone number?"
        }
    ]

// default settings file location for local development under HOME/%USERPROFILE% directory
let settings = ".fsopenai/ServiceSettings.json"
