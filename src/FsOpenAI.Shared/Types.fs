...
exception ConfigurationError of string

type LoadConfig = 
    {
        AppTitle : string option
        RequireLogin : bool
    }
    with static member Default = {AppTitle=None; RequireLogin=false}
...
type CodeEvalParms =
    {
        ///Reference to code that will be evaluated into fsi before evaluation of the generated code
