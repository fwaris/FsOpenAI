FROM mcr.microsoft.com/dotnet/sdk:8.0.204-bookworm-slim AS base
...
FROM prepped AS build
# WORKDIR /nuget_local
# COPY ./docker_extra/ExcelProvider.2.0.1.nupkg .
# RUN dotnet nuget add source /nuget_local --name local
